...
enum StringsVN {
    static let table: [String: String] = [
        ...
        "kudos.detail.sender.anonymous": "Người gửi ẩn danh",
        ...
        "writkudo.field.anonymous_nickname.label": "Nickname ẩn danh",
        "writkudo.field.anonymous_nickname.placeholder": "VD: Doraemon",
        "writkudo.validation.missing_required": "Bạn cần điền đủ Người nhận, Lời nhắn gửi và Hashtag để gửi Kudos!",
