...
enum StringsJA {
    static let table: [String: String] = [
        ...
        "kudos.detail.sender.anonymous": "匿名の送信者",
        ...
        "writkudo.field.anonymous_nickname.label": "匿名ニックネーム",
        "writkudo.field.anonymous_nickname.placeholder": "例: Doraemon",
        "writkudo.validation.missing_required": "Kudosを送信するには、受信者、メッセージ、ハッシュタグをすべて入力してください。",
